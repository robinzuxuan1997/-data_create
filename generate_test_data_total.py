...
def generate(single_file_row,single_file_col, file_num):
    for i in range(file_num):
        __generate(single_file_row,single_file_col, i)


if __name__=="__main__":
    single_file_row = int(sys.argv[1])
    single_file_col = int(sys.argv[2])
    file_num = int(sys.argv[3])
    generate(single_file_row,single_file_col, file_num)
